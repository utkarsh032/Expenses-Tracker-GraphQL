...
import TransactionSkeleton from "../components/Skeltons/TransactionSkelton";
...
const TransactionPage = () => {
  ...
  return (
    <div className='h-screen max-w-4xl mx-auto flex flex-col items-center' style={{ zIndex: 9999 }}>
